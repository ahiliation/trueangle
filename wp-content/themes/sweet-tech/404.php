...
<li>Follow us on <a href="<?php echo sweettech_get_options("twitter");?>" target="_blank">Twitter</a>, <a href="<?php echo sweettech_get_options("facebook");?>" target="_blank">Facebook</a> to stay in touch with us for new updates.</li>
<li>Go back to <a href="<?php echo esc_url(home_url('/')); ?>">Homepage</a> and then start browsing.</li>
</ul>
	  <br/>
