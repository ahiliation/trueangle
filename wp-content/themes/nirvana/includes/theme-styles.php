...
function nirvana_enqueue_styles() {
	...
	if($nirvana_googlefont) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+', $nirvana_googlefont ));
	if($nirvana_googlefonttitle) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+',$nirvana_googlefonttitle ));
	if($nirvana_googlefontside) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+',$nirvana_googlefontside ));
	if($nirvana_googlefontwidget) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+',$nirvana_googlefontwidget ));
	if($nirvana_sitetitlegooglefont) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+',$nirvana_sitetitlegooglefont ));
	if($nirvana_menugooglefont) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+',$nirvana_menugooglefont ));
	if($nirvana_headingsgooglefont) $gfonts[] = esc_attr(preg_replace( '/\s+/', '+',$nirvana_headingsgooglefont ));
