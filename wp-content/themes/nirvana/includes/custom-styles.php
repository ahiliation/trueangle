...
<?php
////////// FONTS //////////
$nirvana_googlefont = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_googlefont)));
$nirvana_googlefonttitle = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_googlefonttitle)));
$nirvana_googlefontside = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_googlefontside)));
$nirvana_googlefontwidget = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_googlefontwidget)));
$nirvana_headingsgooglefont = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_headingsgooglefont)));
$nirvana_sitetitlegooglefont = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_sitetitlegooglefont)));
$nirvana_menugooglefont = str_replace('+',' ',preg_replace('/[:&].*/','',esc_html($nirvana_menugooglefont)));
?>
body { font-family: <?php echo esc_html(((!$nirvana_googlefont)?$nirvana_fontfamily:"\"$nirvana_googlefont\"")); ?>; }
#content h1.entry-title a, #content h2.entry-title a, #content h1.entry-title , #content h2.entry-title {
		font-family: <?php echo esc_html(((!$nirvana_googlefonttitle)?(($nirvana_fonttitle == 'General Font')?'inherit':$nirvana_fonttitle):"\"$nirvana_googlefonttitle\"")); ?>; }
.widget-title, .widget-title a { line-height: normal;
		font-family: <?php echo esc_html(((!$nirvana_googlefontside)?(($nirvana_fontside == 'General Font')?'inherit':$nirvana_fontside):"\"$nirvana_googlefontside\""));  ?>;  }
.widget-container, .widget-container a {
		font-family: <?php echo esc_html(((!$nirvana_googlefontwidget)?(($nirvana_fontwidget == 'General Font')?'inherit':$nirvana_fontwidget):"\"$nirvana_googlefontwidget\""));  ?>;  }
...
.nivo-caption h2, #front-text1 h1, #front-text2 h1, .column-header-image  {
		font-family: <?php echo esc_html(((!$nirvana_headingsgooglefont)?(($nirvana_headingsfont == 'General Font')?'inherit':$nirvana_headingsfont):"\"$nirvana_headingsgooglefont\""));  ?>; }
#site-title span a {
		font-family: <?php echo esc_html(((!$nirvana_sitetitlegooglefont)?(($nirvana_sitetitlefont == 'General Font')?'inherit':$nirvana_sitetitlefont):"\"$nirvana_sitetitlegooglefont\""));  ?>; }
#access ul li a, #access ul li a span {
		font-family: <?php echo esc_html(((!$nirvana_menugooglefont)?(($nirvana_menufont == 'General Font')?'inherit':$nirvana_menufont):"\"$nirvana_menugooglefont\""));  ?>; }
...
<?php if ($nirvana_topbar == 'Hide'){ ?> display:none; <?php } 
	...
	background-color:  <?php echo esc_html($nirvana_topbarcolorbg); ?>;border-bottom-color:<?php echo esc_html(cryout_hexadder($nirvana_topbarcolorbg,'40'));?>;
	-moz-box-shadow: 3px 0 3px <?php echo esc_html(cryout_hexadder($nirvana_topbarcolorbg,'-40'));?>; 
	-webkit-box-shadow: 3px 0 3px <?php echo esc_html(cryout_hexadder($nirvana_topbarcolorbg,'-40'));?>; 
	box-shadow: 3px 0 3px <?php echo esc_html(cryout_hexadder($nirvana_topbarcolorbg,'-40'));?>; 
...
.topmenu ul li a { color: <?php echo esc_html($nirvana_topmenucolortxt); ?>; }
...
.column-header-image {color: <?php echo esc_html($nirvana_linkcolortext); ?>;}
...
echo esc_html("#front-columns > div:nth-child(1n+2) {transform:rotate(". rand(-5,-2)."deg);-webkit-transform:rotate(". rand(-7,7)."deg);} ");
echo esc_html("#front-columns > div:nth-child(2n+1) {transform:rotate(". rand(-2,2)."deg);-webkit-transform:rotate(". rand(-7,7)."deg);} ");
echo esc_html("#front-columns > div:nth-child(3n+2) {transform:rotate(". rand(2,5)."deg);-webkit-transform:rotate(". rand(-7,7)."deg);} ");
echo esc_html("#front-columns > div:nth-child(5n+3) {transform:rotate(". rand(-5,-2)."deg);-webkit-transform:rotate(". rand(-7,7)."deg);} ");
echo esc_html("#front-columns > div:nth-child(7n+5) {transform:rotate(". rand(-2,2)."deg);-webkit-transform:rotate(". rand(-7,7)."deg);} ");
echo esc_html("#front-columns > div:nth-child(11n+7) {transform:rotate(". rand(2,5)."deg);-webkit-transform:rotate(". rand(-7,7)."deg);} ");
?>
#front-columns > div {
